...
import CustomShadowMaterial from 'three-custom-shader-material/vanilla'
...
const slicedMaterial = new CustomShadowMaterial({
...
const slicedDepthMaterial = new CustomShadowMaterial({
    // MeshStandardMaterial
