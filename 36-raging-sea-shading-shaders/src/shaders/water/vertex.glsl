...
void main()
{
    ...
    vec3 modelPositionA = modelPosition.xyz + vec3(shift, 0.0, 0.0);        // only on the x-axis
    vec3 modelPositionB = modelPosition.xyz + vec3(0.0, 0.0, -shift);       // only on the z-axis
    // why -shift? cross product! it has to be positive cuz plane is facing upward
