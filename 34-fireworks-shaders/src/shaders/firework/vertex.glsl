...
void main(){
    ...
    exploadingProgress = 1.0 - pow(1.0 - exploadingProgress, 2.0);
    ...
    // field of view is vertical. so the resolution should be changed according to the vertical size not horizontal size.
