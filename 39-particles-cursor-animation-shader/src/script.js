...
// Vector2(0,0) this means the cursor is center of the screen -> so change it to 9999,9999. displace the center!
displacement.canvasCursor = new THREE.Vector2(9999, 9999)
displacement.canvasCursorPrevious = new THREE.Vector2(9999, 9999)

// pointermove and mousemove is kinda same thing, but it works on mobile too
...
const tick = () => {
     ...
     * Displacement
     */
    displacement.context.globalCompositeOperation = 'source-over'    // default!
